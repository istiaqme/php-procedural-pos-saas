      <div class="topbar">
        ...
        <div class="topbar-left">
          ...
          <span>
          <img src="<?php echo "$ASSETS/IMAGES"; ?>/logo.png" alt="" height="60">
          </span>
          <i>
          <img src="<?php echo "$ASSETS/IMAGES"; ?>/logo_sm.png" alt="" height="28">
          </i>
          </a>
        </div>
          ...
          <div class="container-fluid">
            ...
            <ul class="nav navbar-right list-inline">
              ...
              <li class="dropdown user-box list-inline-item">
                ...
                <img src="<?php echo "$IMAGES"; ?>/user-icon-show.png" alt="user-img" class="rounded-circle user-img">
                </a>
