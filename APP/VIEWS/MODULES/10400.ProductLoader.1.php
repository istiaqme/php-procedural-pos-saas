                ...
                <div class="row">
                  <div class="col-8">
                    <div class="col-12">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="m-t-0 header-title"><b><?php echo PMLTitle($PMLToken); ?></b></h4>
                          ...
                          <input type="hidden" id="WorkFlowStatus" value="<?php echo "$WorkFlowStatus";  ?>">
                          ...
                          <?php 
                              ...
                              echo "<button type='submit' id='AddNewInProductLoader' class='btn btn-success waves-effect waves-light btn-block'>Add New</button>";
                              echo "</div>";
                            ?>
                  ...
                  <div class="col-4">
                    <div class="row">
                      <!-- <div class="col-12" id="PMLLocker">
                        <div class="form-group">
                          <button class=" btn btn-lg btn-block btn-warning btn-bordered waves-effect waves-light" id="LockerButton">LOCK</button>
                        </div>
                      </div> -->
                      <div class="col-12">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <input type="hidden" id="SingleProductToken" value="">
