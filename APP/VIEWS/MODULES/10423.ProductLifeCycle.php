...
<html lang="en">
  ...
  <body>
            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="page-title-box">
                  <h4 class="page-title">Life Cycle</h4>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p>
                      <span><button class="PLCButton btn btn-info waves-effect waves-light" id="1">In Warehouse</button></span> &nbsp;
    ...
    <script>
      ...
      function LoadPLC(ShowType, ProductToken){
        var PostData = {
          'ShowType' : ShowType,
