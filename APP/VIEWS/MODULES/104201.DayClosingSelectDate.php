            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="page-title-box">
                  <h4 class="page-title">Daily Reports | <?php echo $FromCounterTitle; ?></h4>
                      ...
                      <?php
                          ...
                          while (strtotime($date) <= strtotime($end_date)) {
                            ...
                            echo "<tr>";
                              ...
                              echo "<td><a class='btn btn-info waves-effect waves-light' href = 'index.php?p=business&m=1042012&CounterToken=B1SC2&Date=$end_date'>VIEW</a></td>";
                            echo "</tr>";
                                        //echo "$date\n";
