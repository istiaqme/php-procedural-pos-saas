            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="page-title-box">
                  <h4 class="page-title">Transport List</h4>
                  <ol class="breadcrumb p-0 m-0">
                    <div class="form-inline" action="">
                      <div class="form-group m-r-10">
                        <input type="hidden" id="PMLType" value='2'>
                        <input type="hidden" id="FromCounter" value='<?php echo $Warehouse; ?>'>
                        <input type="hidden" id="ToCounter" value='<?php echo $_GET["ToCounter"]; ?>'>
