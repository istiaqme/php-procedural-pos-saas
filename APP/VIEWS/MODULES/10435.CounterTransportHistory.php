  ...
  <body>
            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="page-title-box">
                  <h4 class="page-title">Product Transport</h4>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    <h4 class="m-t-0 header-title"><b>All Counters</b></h4>
    ...
    <script>
      ...
      $(document).ready(function(){
        var For = "TransportListByCounter";
        LoadAllSalesCounters(For);
      ...
      function LoadAllSalesCounters(For){
        var PostData = {
          'For' : For,
          'UserToken' : UserToken,
